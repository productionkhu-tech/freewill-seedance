...
| 현재 버전 | **v26.6.1209** (실제 2026-06-15 배포 — 라벨은 12xx, §버전/배포 주의 참조) |
...
- ⚠ **1201~1209는 실제 2026-06-15 작업분인데 세션 중 날짜를 6/12로 착각해 `12xx`로 스탬프됨.** 기능·update 감지는 정상(단조 증가). 라벨만 잘못. **다음 버전부터 `26.6.15XX`** (6/15 패치). 1501 > 1209라 업데이트 정상.
