...
import { VideoPlayer, ClipStamp, downloadClip, revealClipFile, mediaSrcFor , originMaybeAlive , posterSrcFor , playbackSrcFor } from './ChatArea';
            ...
            {visible.map(r => (
              <div key={r.id}
                ...
                <div className="aspect-video bg-black relative group">
                  <VideoPlayer src={playbackSrcFor(r)} fallbackSrc={mediaSrcFor(r)} poster={posterSrcFor(r)} posterOf={r} className="w-full h-full" is4k={r.usedSettings?.resolution === '4k'} />
